...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('pic_profile')->default('default.jpg');
        ...
        DB::table('users')->insert([
            ['id' => 1, 'name' => "Pedro Henrique", 'cpf' => "123.456.789-12", 'email' => "pedroh@gmail.com", 'pic_profile' => "images/user/1.jpeg", 'password' => "123456", 'created_at' => "2020/03/03 17:55:00", 'updated_at' => "2020/04/03 17:55:00"],
